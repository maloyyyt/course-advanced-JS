...
export let posts = [];
export let userPostsUserId = null;
...
export const refreshPostsList = () => {
  if (page === USER_POSTS_PAGE && userPostsUserId) {
    return getUserPosts({ token: getToken(), userId: userPostsUserId }).then(
      (newPosts) => {
        posts = newPosts;
        renderApp();
      },
